...
<body>
    <form id="login" class="form-signin">
        <img class="mx-auto d-block mb-4" src="img/logo.png" alt="" width="72" height="72">
        <h1 class="h3 mb-3 font-weight-normal text-center">Painel 2.0</h1>
...
<br />
©Feito por <a href="https://www.youtube.com/megalivre" target="_blank">Megalivre</a></div>
